...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2026 at 10:24 PM
...
(3, 'Pizzarena Budapest - Gozsdu Courtyard', 'A fővárosi pörgés központjában várunk! Itt a gyorsaságon és a prémium minőségen van a hangsúly. Tökéletes választás egy gyors ebédre a munka szünetében, vagy alapozásként a budapesti éjszaka előtt. Itt a Séf ajánlatai mellett \"slice bar\" (szelet bár) is üzemel.', 'https://plus.unsplash.com/premium_photo-1670984939096-f3cfd48c7408?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', '10:00-23:00', '1075 Budapest, Király utca 13.', '+36000000002'),
(4, 'Pizzarena Siófok Marina', 'Közvetlenül a Balaton-parton, a vitorláskikötő mellett! Ez az egységünk a \"Beach-Vibe\" jegyében született: világos, fapadlós terasz, kényelmes babzsákfotelek és koktélbár. Itt a Séf ajánlatai mellett kifejezetten könnyű, nyári salátákat és hideg olasz desszerteket is kínálunk a strandolók számára.', 'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', '9:00-19:00', '8600 Siófok, Petőfi sétány 3.', '+36000000003');
